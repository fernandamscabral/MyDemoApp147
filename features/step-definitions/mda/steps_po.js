...
import { productDetailsPage } from "../../pageobjects/mda/product_details.page";
...
Then("exibe a pagina de detalhe com o {string}", async (nome_produto) => {
    const lbl_nome_produto = productDetailsPage.lbl_titulo_produto;
...
Then("o {string}", async (preco_produto) => {
    ...
    const lbl_preco_produto = productDetailsPage.lbl_preco_produto;
